...
namespace Worldreaver.RectEx
{
    internal static class MoveToExtensions
    {
        ...
        public static Rect MoveRightFor(this Rect rect,
            float newWidth,
            float space = SPACE)
        {
            rect = rect.Abs();
        ...
        public static Rect MoveLeftFor(this Rect rect,
            float newWidth,
            float space = SPACE)
        {
            rect = rect.Abs();
        ...
        public static Rect MoveUpFor(this Rect rect,
            float newHeight,
            float space = SPACE)
        {
            rect = rect.Abs();
        ...
        public static Rect MoveDownFor(this Rect rect,
            float newHeight,
            float space = SPACE)
        {
            rect = rect.Abs();
