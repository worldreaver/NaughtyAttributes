...
public class EnumPropertyDrawer : PropertyDrawer
{
        ...
        GUIContent label)
    {
        ...
        if (_idHash == 0) _idHash = "SearchableEnumDrawer".GetHashCode();
        ...
        if (DropdownButton(id, position, buttonText))
        {
            ...
            EnumPopup.Show(position, property.enumDisplayNames, property.enumValueIndex, onSelect);
        }
    ...
    /// </summary>
    private static bool DropdownButton(int id,
        Rect position,
        GUIContent content)
    {
...
/// </summary>
public class EnumPopup : PopupWindowContent
{
    #region -- Constants --------------------------------------------------
    ...
    public static void Show(Rect activatorRect,
        string[] options,
        int current,
        Action<int> onSelectionMade)
    {
        EnumPopup win = new EnumPopup(options, current, onSelectionMade);
    ...
    private EnumPopup(string[] names,
        int currentIndex,
        Action<int> onSelectionMade)
    {
    ...
    private void DrawRow(Rect rowRect,
        int i)
    {
